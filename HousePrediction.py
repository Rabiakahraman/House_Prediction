...
# 1. Genel Resim
# 2. Kategorik Değişken Analizi (Analysis of Categorical Variable
...
train = pd.read_csv("7.hafta Machine learning/ödevler/HousePrediction/datasets/train.csv")
test = pd.read_csv("7.hafta Machine learning/ödevler/HousePrediction/datasets/test.csv")
